...
$routes->post('admin/updateEspecie/(:num)', 'Admin::updateSpecies/$1');
$routes->get('/admin/deleteSpecies/(:num)', 'Admin::deleteSpecies/$1', ['filter' => 'auth:Administrador']);
$routes->post('admin/deleteEspecie/(:num)', 'Admin::deleteSpecies/$1');
...
$routes->post('/amigo/comprar', 'Amigo::postCompra', ['filter' => 'auth:Amigo']);
