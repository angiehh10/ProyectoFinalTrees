...
$routes->get('/amigo/comprar/(:num)', 'Amigo::comprar/$1', ['filter' => 'auth:Amigo']); // Página para comprar un árbol
$routes->post('/amigo/comprar/(:num)', 'Amigo::comprar/$1', ['filter' => 'auth:Amigo']); // Procesar compra de un árbol
